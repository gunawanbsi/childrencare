<section class="vh-100 mt-5">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-md-9 col-lg-6 col-xl-5">
        <img src="<?php echo base_url()?>assets/img/logo1.png" class="img-fluid" alt="Sample image" style="margin-left:10rem; width:50%;">
      </div>
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        ...
        <form method="post" action="<?= base_url('auth'); ?>">
          ...
          <div class="text-center text-lg-start mt-4 pt-2">
            ...
            <p class="small fw-bold mt-5 pt-1 mb-0">Belum Punya Akun? <a href="<?php echo base_url().'auth/registrasi'?>" class="link-danger">Daftar Sekarang</a></p>
          </div>
