<section class="section-padding" id="section_3">
            <div class="container">
                <div class="row">
                    ...
                    <?= $this->session->flashdata('pesan'); ?>
                        <h2>Konsultasi Bayi</h2>
                        <p>Konsultasi mengenai Bayi anda dengan Dokter kami.<br>
            ...
            <div class="col-lg-12 col-12 text-center mb-5 mt-5">
                ...
                <form method="post" action="<?= base_url('user/proseskonsul'); ?>" style="margin-left: 10rem;">
                    ...
                    <div class="form-outline mb-3 col-lg-10">
                        <input type="text"  class="form-control form-lg" placeholder="Alamat Pasien" id="alamat_pasien" name="alamat_pasien">
                    ...
                    <div class="form-outline mb-3 col-lg-10">
                        <input type="hidden"  class="form-control form-lg" placeholder="Kategori Anak" name="kategori_anak" value="2">
                    </div>
                    <div class="form-outline mb-3 col-lg-10">
